    ...
    if conn:
        ...
        try:
            ...
            SELECT 
                ...
                us.usage, us.amount, us.carbon_emission, us.remark AS usage_remark, us.img_path, us.user_id AS usage_user_id, uf.username AS usage_username, 
            ...
            electricities = defaultdict(lambda: {
                "usage": []  # Initialize with an empty list for fill records
            })
            ...
            for record in electricity_records:
                ...
                if record[9]:  # If there is a fill record
                    electricities[electricity_id]["usage"].append({
                        "usage_id": record[9],
                        "Doc_date": record[10],
