...
from .ch4Def import set_ch4_table1,set_ch4_table2,set_ch4_table3,set_ch4_stairs1,set_ch4_stairs2,set_ch4_stairs3,set_ch4_stairs4,set_ch4_stairs5,set_ch4_stairs6,set_ch4_table1_7
...
################################################################################
    stairs2 = doc.add_paragraph("E. 逸散排放源（冷媒）：")
    ...
    table_explain = doc.add_paragraph("表4-9、設備之冷媒逸散率排放因子")
    set_explain(table_explain)
    table1 = doc.add_table(rows=9, cols=3)
    set_ch4_table2(table1)

    table_explain = doc.add_paragraph("表4-10、逸散排放源（冷媒）排放源HFCs")
    set_explain(table_explain)
...
############################################################################
    ...
    table_explain = doc.add_paragraph("表4-11、間接排放源（外購電力）排放源")
    set_explain(table_explain)
    table4 = doc.add_table(rows=3, cols=16)
    set_ch4_table1_7(table4)
    ...
    table_explain = doc.add_paragraph("表4-12、活動數據蒐集彙整表")
    set_explain(table_explain)
