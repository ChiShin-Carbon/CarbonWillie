...
async def read_user_credentials(
    ...
    if conn:
        ...
        try:
            query = """
                INSERT INTO Employee (user_id, period_date, emoloyee_number, daily_hours, workday, overtime,
                                      sick_leave, personal_leave, business_trip, wedding_and_funeral, special_leaave,
