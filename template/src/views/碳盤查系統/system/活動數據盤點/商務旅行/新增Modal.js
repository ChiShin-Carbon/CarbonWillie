...
export const BusinessTripAdd = ({ 
    ...
    const safeRefresh = async () => {
        ...
        try {
            ...
            // Then try our local refresh
                ...
                console.log("Using localRefreshData.refreshBusinessTripData");
    ...
    // Transportation options - added additional options compared to original
    ...
    return (
        ...
        >
            <CModalHeader>
                <CModalTitle id="ActivityModalLabel"><b>新增出差紀錄</b></CModalTitle>
            </CModalHeader>
