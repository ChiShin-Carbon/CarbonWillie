...
export const OperationalWasteAdd = ({ 
    isAddModalVisible, 
    setAddModalVisible,
    refreshWasteData, 
    setCurrentFunction,
    ...
    const validateForm = () => {
        ...
        if (!formData.waste_item) errors.waste_item = '請輸入廢棄物項目';
    ...
    const safeRefresh = async () => {
        console.log("Attempting to refresh waste data...");
        try {
            ...
            // Then try our local refresh
                ...
                console.log("Using localRefreshData.refreshWasteData");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formDataToSend.append("waste_item", formData.waste_item);
    ...
    return (
        ...
        >
            <CModalHeader>
                <CModalTitle id="ActivityModalLabel"><b>新增廢棄物紀錄</b></CModalTitle>
            </CModalHeader>
